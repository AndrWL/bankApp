...
class RegistrationViewController: UIViewController {
   ...
   private  let email = UITextField(backgroundColor: .lightGray, placeholder: "Email", borderStyle: .roundedRect, textColor: .darkGray)
   ...
   func setupStackView() {
    ...
    @objc func registerButtonTapped() {
        ...
        AuthService.shared.register(email: email.text, password: password.text) { [weak self] (result) in
            switch result {
    ...
    deinit {
        print("RegistrationController Delete")
    }
}
